---
publication_id: atlas-lite-obsidian-hermes
locale: zh-CN
status: published
content_version: 1.0.0
last_reviewed: 2026-08-25
evidence_note: 产品行为以文末所列官方资料和读者本机实际版本为准。
open_question: 不同 Hermes 版本和非本地 terminal backend 下的 worktree isolation 行为需在安装现场复核。
---
